...
func.func @main() {
    ...
    %1= arith.constant dense<[1.0, 2.0, 3.0]>:tensor<3xf32>
    %2 = call @test(%0,%1) : (tensor<3xf32>,tensor<3xf32>) -> tensor<5xf32>
    %unranked = tensor.cast %2 : tensor<5xf32>to tensor<*xf32>
    call @printMemrefF32(%unranked) : (tensor<*xf32>) -> () 
    return 
} 
func.func private @printMemrefF32(tensor<*xf32>)
func.func @test(%arg0: tensor<3xf32>, %arg1: tensor<3xf32>)->tensor<5xf32>{
