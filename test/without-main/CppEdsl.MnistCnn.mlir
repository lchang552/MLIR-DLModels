...
module @mnist_cnn {
  func @main(%arg0: tensor<1x224x224x1xf32>, %arg1: tensor<3x3x1x32xf32>, %arg2: tensor<32xf32>, %arg3: tensor<3x3x32x64xf32>, %arg4: tensor<64xf32>, %arg5: tensor<802816x128xf32>, %arg6: tensor<128xf32>, %arg7: tensor<128x100xf32>, %arg8: tensor<100xf32>) -> tensor<1x100xf32> {
    %cst = arith.constant 0xFF800000 : f32
    %cst_0 = arith.constant 0.000000e+00 : f32
    %0 = linalg.init_tensor [1, 224, 224, 1] : tensor<1x224x224x1xf32>
    ...
    %3 = linalg.init_tensor [1, 224, 224, 32] : tensor<1x224x224x32xf32>
    ...
    %6 = linalg.init_tensor [1, 224, 224, 32] : tensor<1x224x224x32xi1>
    ...
    %8 = linalg.init_tensor [1, 224, 224, 32] : tensor<1x224x224x32xf32>
    ...
    %11 = linalg.init_tensor [1, 224, 224, 64] : tensor<1x224x224x64xf32>
    ...
    %14 = linalg.init_tensor [1, 224, 224, 64] : tensor<1x224x224x64xi1>
    ...
    %16 = linalg.init_tensor [1, 224, 224, 64] : tensor<1x224x224x64xf32>
    ...
    %18 = linalg.init_tensor [1, 112, 112, 64] : tensor<1x112x112x64xf32>
    ...
    %22 = linalg.init_tensor [1, 128] : tensor<1x128xf32>
    ...
    %25 = linalg.init_tensor [1, 128] : tensor<1x128xi1>
    ...
    %27 = linalg.init_tensor [1, 128] : tensor<1x128xf32>
    ...
    %29 = linalg.init_tensor [1, 100] : tensor<1x100xf32>
    ...
    %35 = linalg.init_tensor [1, 100] : tensor<1x100xf32>
    ...
    %37 = linalg.init_tensor [1, 100] : tensor<1x100xf32>
    ...
    %42 = linalg.init_tensor [1, 100] : tensor<1x100xf32>
