...
module @minimum {
  func @main(%arg0: tensor<10x20xf32>, %arg1: tensor<10x20xf32>) -> tensor<10x20xf32> {
    ...
    %3 = linalg.generic {indexing_maps = [#map, #map, #map, #map], iterator_types = ["parallel", "parallel"]} ins(%1, %arg0, %arg1 : tensor<10x20xi1>, tensor<10x20xf32>, tensor<10x20xf32>) outs(%2 : tensor<10x20xf32>) {
