...
module @defract_long {
  func @main(%arg0: tensor<1x3x3x1xf32>, %arg1: tensor<1x3x3x1xf32>) -> tensor<1x5x5x1xf32> {
    %cst = arith.constant 0.000000e+00 : f32
    %0 = linalg.init_tensor [1, 3, 3, 1] : tensor<1x3x3x1xf32>
    ...
    %3 = linalg.init_tensor [1, 3, 3, 1] : tensor<1x3x3x1xf32>
    ...
    %6 = linalg.init_tensor [1, 5, 5, 1] : tensor<1x5x5x1xf32>
    %7 = linalg.fill ins(%cst : f32) outs(%6 : tensor<1x5x5x1xf32>) -> tensor<1x5x5x1xf32>
    %8 = linalg.generic {indexing_maps = [#map1, #map2, #map3], iterator_types = ["reduction", "parallel", "window", "window", "window", "window", "parallel", "reduction", "reduction", "reduction", "reduction"]} ins(%2, %5 : tensor<1x3x5x1xf32>, tensor<1x4x3x1xf32>) outs(%7 : tensor<1x5x5x1xf32>) attrs =  {constraints = #set, iterator_ranges = [1, 1, 1, 2, 2, 3, 1, 1, 1, 2, 1]} {
