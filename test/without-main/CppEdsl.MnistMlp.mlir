...
module @mnist_mlp {
  func @main(%arg0: tensor<1x784xf32>, %arg1: tensor<784x512xf32>, %arg2: tensor<512xf32>, %arg3: tensor<512x512xf32>, %arg4: tensor<512xf32>, %arg5: tensor<512x10xf32>, %arg6: tensor<10xf32>) -> tensor<1x10xf32> {
    ...
    %3 = linalg.init_tensor [1, 512] : tensor<1x512xi1>
    ...
    %5 = linalg.init_tensor [1, 512] : tensor<1x512xf32>
    ...
    %7 = linalg.init_tensor [1, 512] : tensor<1x512xf32>
    ...
    %10 = linalg.init_tensor [1, 512] : tensor<1x512xi1>
    ...
    %12 = linalg.init_tensor [1, 512] : tensor<1x512xf32>
    ...
    %14 = linalg.init_tensor [1, 10] : tensor<1x10xf32>
    ...
    %17 = linalg.init_tensor [1, 1] : tensor<1x1xf32>
    ...
    %24 = linalg.init_tensor [1, 1] : tensor<1x1xf32>
    ...
    %27 = linalg.init_tensor [1, 10] : tensor<1x10xf32>
