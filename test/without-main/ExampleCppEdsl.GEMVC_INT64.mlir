...
#map5 = affine_map<(d0) -> ()>
module @gemvc {
  func @main(%arg0: tensor<3x3xi64>, %arg1: tensor<3xi64>, %arg2: tensor<3xi64>) -> tensor<3xi64> {
    ...
    %2 = linalg.init_tensor [3] : tensor<3xi64>
    ...
    %5 = linalg.init_tensor [3] : tensor<3xi64>
    ...
    %7 = linalg.init_tensor [3] : tensor<3xi64>
