...
module @lars_momentum4d {
  func @main(%arg0: tensor<4x7x3x9xf32>, %arg1: tensor<4x7x3x9xf32>, %arg2: tensor<4x7x3x9xf32>, %arg3: tensor<f32>) -> (tensor<4x7x3x9xf32>, tensor<4x7x3x9xf32>) {
    %cst = arith.constant 0.000000e+00 : f32
    %cst_0 = arith.constant 1.250000e-01 : f32
    %cst_1 = arith.constant 9.765625E-4 : f32
    %cst_2 = arith.constant 4.8828125E-4 : f32
    %0 = linalg.init_tensor [4, 7, 3, 9] : tensor<4x7x3x9xf32>
    ...
    %4 = linalg.init_tensor [4, 7, 3, 9] : tensor<4x7x3x9xf32>
    ...
    %13 = linalg.init_tensor [4, 7, 3, 9] : tensor<4x7x3x9xf32>
    ...
    %15 = linalg.init_tensor [] : tensor<f32>
    ...
    %18 = linalg.init_tensor [] : tensor<f32>
    ...
    %22 = linalg.init_tensor [] : tensor<f32>
    ...
    %24 = linalg.init_tensor [] : tensor<f32>
    ...
    %26 = linalg.init_tensor [4, 7, 3, 9] : tensor<4x7x3x9xf32>
    ...
    %28 = linalg.init_tensor [4, 7, 3, 9] : tensor<4x7x3x9xf32>
    ...
    %30 = linalg.init_tensor [4, 7, 3, 9] : tensor<4x7x3x9xf32>
    ...
    %32 = linalg.init_tensor [4, 7, 3, 9] : tensor<4x7x3x9xf32>
    ...
    %34 = linalg.init_tensor [4, 7, 3, 9] : tensor<4x7x3x9xf32>
