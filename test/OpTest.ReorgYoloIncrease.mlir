...
func.func @main() {
    ...
    %1 = call @test(%0) : (tensor<1x4x6x6xi64>) -> tensor<1x16x3x3xi64>
    %unranked = tensor.cast %1 : tensor<1x16x3x3xi64>to tensor<*xi64>
    call @printMemrefI64(%unranked) : (tensor<*xi64>) -> () 
    return 
} 
func.func private @printMemrefI64(tensor<*xi64>)
func.func @test(%arg0: tensor<1x4x6x6xi64>)->tensor<1x16x3x3xi64>{
